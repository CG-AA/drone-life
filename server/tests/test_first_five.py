...
opening mission (freefly) and on the main game (delivery). Real subprocess,
real MAVLink, unthrottled sim; this is the flight every student's first Run
performs.
"""
...
@pytest.mark.parametrize("mission", ["freefly", "delivery"])
