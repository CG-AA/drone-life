...
| `steel chewed at …` / `clay chewed at …` / `repair at N 9 E -62 hover 6` | walls reroute creeps; a ring, long wall or beacon gets eaten, clay 3× faster; carrying the right tile nearby? hover the hole at that height → `repaired! +1` |
...
| `clay pit at N 50 E -44` · `ring tower at …! +25` · `beacon up at …` · `bell up at …, hover 8 m to ring` | clay: walls, beacon ends, bell · 6 steel around a tower = 28 m reach · clay-steel-clay singles lure creeps within 25 m · 6-clay ring + 3 clay: hover on top 3 s mid-wave, every creep freezes 15 s |
